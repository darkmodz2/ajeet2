...
OWNER_IDS = [7468235894, 6404882101, 6902791681]  # यहां मालिक के टेलीग्राम आईडी
...
# नई प्राइस लिस्ट के अनुसार ड्यूरेशन
VALID_DURATIONS = {
    "5 hour": (50, 5/24),
    "1 day": (149, 1),
    "2 days": (199, 2),
...
def handle_menu(message):
    ...
    elif "buy key" in text or "🔐🔑" in text:  # KEY FIX HERE
        send_price_list(message.chat.id)
...
if __name__ == '__main__':
    logging.basicConfig(level=logging.INFO)  # लॉगिंग एनेबल करें
